...
import * as import1 from './TagInputModel';
...
class RlTagInputModuleInjector extends import0.NgModuleInjector<import1.RlTagInputModule> {
  ...
  get _NgLocalization_5():import5.NgLocaleLocalization {
    if ((this.__NgLocalization_5 == (null as any))) { (this.__NgLocalization_5 = new import5.NgLocaleLocalization(this.parent.get(import9.LOCALE_ID))); }
